...
<div id="body">
	...
	<div class="d-flex mb-3" style="width: 1410px;">
		<button type="button" class="btn btn-primary ms-auto" style="text-align: right; width:105px; margin-right: 10px;" onclick="location.href='teacher_signup'" aria-label="교사 등록">
		교사 등록
		</button>
	</div>
	<div class="d-flex mb-3"> 
		<form class="d-flex align-items-center gap-2" role="search" aria-label="사용자 검색 폼">
