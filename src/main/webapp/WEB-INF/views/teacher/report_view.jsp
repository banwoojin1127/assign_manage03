                    ...
                    <div class="d-flex px-1">
					    ...
					    <c:choose>
						    <c:when test="${not empty feedback}">
						        <a href="<c:url value='/teacher/assign/${assign.assign_no}/report/${report.report_no}/feedback/modify'/>" 
						           class="whiteBtn btn d-flex flex-wrap align-content-center rounded my-1">
						            수정
						        </a>
						    </c:when>
						    <c:otherwise>
						        <a href="<c:url value='/teacher/assign/${assign.assign_no}/report/${report.report_no}/feedback/submit'/>" 
						           class="whiteBtn btn d-flex flex-wrap align-content-center rounded my-1">
						            등록
						        </a>
						    </c:otherwise>
